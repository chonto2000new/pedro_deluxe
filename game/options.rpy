...
define config.name = _("las flipantes aventuras de pedro Deluxe")
...
define build.name = "lasflipantesaventurasdepedroDeluxe"
...
define config.save_directory = "lasflipantesaventurasdepedroDeluxe-1742621238"
